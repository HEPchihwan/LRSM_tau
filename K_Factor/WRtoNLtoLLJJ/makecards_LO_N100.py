...
while (WRMASS <= WRMASSEND):
    ...
    os.system("cp skeletons_for_LO_N100/run_card.dat "+DIRNAME+"/"+DIRNAME+"_run_card.dat") 
    os.system("cp skeletons_for_LO_N100/extramodels.dat "+DIRNAME+"/"+DIRNAME+"_extramodels.dat")
    proclines_path = "skeletons_for_LO_N100/proc_card.dat"
    custolines_path = "skeletons_for_LO_N100/customizecards.dat"
