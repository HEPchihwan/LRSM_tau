...
dirname = "/data6/Users/snuintern1/nano3/CMSSW_10_6_22/src/PhysicsTools/NanoAODTools/python/postprocessing/analyzer/analyzer/LHE_reco/run_result/result/merged_files"
    ...
    for var in d_plots[obj]: # 오브젝트별로 [pt,eta], 또는 [mass] 등 반복
        for mWR in d_mp:     # mWR 후보들 (1000, 2000, 4000)
            ...
            for mN in d_mp[mWR]:
                ...
                if obj == "N":
                    h.GetXaxis().SetTitle("N mass reconstruct")
                    if mWR ==1000: 
                        h.Rebin(5)
                        h.SetTitle("")
                        h.GetXaxis().SetRangeUser(0, mWR*1.2)
